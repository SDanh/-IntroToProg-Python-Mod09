...
# SDanh,9.6.2020,Edited employee input to cast ID to int, added ValueError exception
# ---------------------------------------------------------- #
...
class EmployeeIO:
    ...
    def input_employee_data():
        ...
        try:
            ...
            print("WRONG DATA TYPE: ID MUST be a number, First & Last Name MUST be strings!")
